	...
	const contactInfo = [
		{
			...
			title: "Email",
			value: "katsiev1997@gmail.com",
			link: "mailto:katsiev1997@gmail.com",
		},
		{
			icon: <Phone className="h-5 w-5 text-primary" />,
			title: "Phone",
			value: "+7 (962) 648-8817",
			link: "tel:+79626488817",
		},
		{
	...
	const socialLinks = [
		{
			...
			name: "GitHub",
			link: "https://github.com/katsiev1997",
		},
		{
			icon: <Linkedin className="h-5 w-5" />,
			name: "VK",
			link: "https://vk.com/mikail_katsiev",
		},
		{
			icon: <Instagram className="h-5 w-5" />,
			name: "Instagram",
			link: "https://instagram.com/mikail_katsiev",
		},
	];
